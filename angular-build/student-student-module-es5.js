(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["student-student-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FreshersComponent = /** @class */ (function () {
                function FreshersComponent(router, traineeservice) {
                    this.router = router;
                    this.traineeservice = traineeservice;
                }
                FreshersComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.student.salary = this.salary;
                    this.studentpd.gender = this.gender;
                    this.student.bond = this.bond;
                    this.traineeservice.saveamenities(this.ameneties).subscribe(function (result) { return _this.result; });
                    this.traineeservice.savestudentpd(this.studentpd).subscribe(function (result) { return _this.result; });
                    this.traineeservice.savestudent(this.student).subscribe(function (result) { return _this.result; });
                };
                FreshersComponent.prototype.gotoadd = function () {
            ...
            FreshersComponent.ctorParameters = function () { return [
